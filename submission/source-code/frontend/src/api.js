...
export const api = {
  ...
  likePost: (postId) => post(`/community/posts/${postId}/like/`),
  createComment: (postId, payload) => post(`/community/posts/${postId}/comments/`, payload),
  updateComment: (postId, commentId, payload) => put(`/community/posts/${postId}/comments/${commentId}/`, payload),
  deleteComment: (postId, commentId) => remove(`/community/posts/${postId}/comments/${commentId}/`),
};
